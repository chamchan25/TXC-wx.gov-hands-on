...
![ワークフロー全体像](image/practice3-1-1.png)
...
![自分のタスク](image/practice3-1.png)

### 2. Risk Identificationへの回答

`Risk Identification`をクリックします。

![Risk_Identification](image/practice3-2.png)
...
![リスク識別の完了](image/practice3-3.png)
...
![グリッド起動ページ](image/practice3-8.png)

[名前]左隣のチェックボックスをクリックして、リスクを一括選択したのち、`一括更新`をクリックします。

![一括選択](image/practice3-9.png)
...
![リスク一括更新](image/practice3-10.png)
