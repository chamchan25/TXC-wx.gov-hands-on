...
![ビュータブ開く](image/practice5-5.png)

画面が遷移したら、画面右にある`新規追加`ボタンをクリックします。

![新規追加](image/practice5-6.png)
